...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            '--count',
            type=int,
            # Was 20, change it back!
            default=15,
            help='Number of market events to generate (default is 20)'
        )
    ...
    def handle(self, *args, **options):
        ...
        events = [
            ...
            ("ESG Reporting Mandate",
             "A new mandate requiring ESG reporting increases transparency and investor confidence."),
            ...
            ("Trump does a Backflip",
             "The African leaders he was meeting with were very impressed, and so is the market!"),
        ...
        for i in range(count):
            ...
            # Choose a random impact factor between -0.25 and +0.25
            impact = Decimal(random.uniform(-0.30, 0.30)).quantize(Decimal('0.01'))
            ...
            if companies:
                # Randomly assign a subset of companies, for example between 1 and half of the available companies
